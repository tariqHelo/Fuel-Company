...
<div class="card-body">
    <div class="row">
      ...
      <div class="col-4">
          ...
          <input type="string" name="size" class="form-control"  placeholder="أدخل السعر" value="{{old('size')}}">
      </div>
    </div>
    ...
    <div class="mt-repeater-item">
        <div class="row">
            <div class="col-md-2">
                ...
                <input  name="data[0][meter1]" class="form-control" type="string" placeholder="ماكينة رقم 1">
            </div>
            <div class="col-md-2">
                <label class="control-label"> عداد 2 </label>
                <input  name="data[0][meter2]"   class="form-control" type="string" placeholder="ماكينة رقم 2">
            </div>
            <div class="col-md-2">
                <label class="control-label"> عداد 3</label>
                <input  name="data[0][meter3]" class="form-control" type="string" placeholder="ماكينة رقم 3">
            </div>
            <div class="col-md-2">
                <label class="control-label"> عدداد 4</label>
                <input  name="data[0][meter4]"  class="form-control" type="string" placeholder="ماكينة رقم 4">
            </div>
            <div class="col-md-2">
                <label class="control-label">عداد 5</label>
                <input  name="data[0][meter5]"    class="form-control" type="string" placeholder="ماكينة رقم 5">
            </div>
            <div class="col-md-1">
                <label class="control-label">عداد 6</label>
                <input  name="data[0][meter6]"    class="form-control" type="string" placeholder="ماكينة رقم 6">
            </div>
  ...
  <div class="card-footer">
    <button type="submit" class="btn btn-primary">{{$button}}</button>
        <a href="{{route('petrol95.index')}}" class="btn btn-danger" type="button"> إلغاء</a>
  </div>
<!-- /.card -->
