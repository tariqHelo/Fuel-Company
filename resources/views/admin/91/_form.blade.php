...
<div class="card-body">
    <div class="row">
      ...
      <div class="col-4">
        ...
        <input type="number" name="caliber" class="form-control"  placeholder="أدخل كمية العيار" value="{{old('caliber')}}">
      </div>
      <div class="col-4">
          <label for="exampleInputEmail1">المقاس</label>
          <input type="number" name="size" class="form-control"  placeholder="أدخل  مقاس الخزان" value="{{old('size')}}">
      </div>
    </div>
    ...
    <div class="mt-repeater-item">
        <div class="row">
            <div class="col-md-2">
                ...
                <input  name="data[0][meter1]" class="form-control" type="number" >
            </div>
            <div class="col-md-2">
                <label class="control-label"> عداد 2 </label>
                <input  name="data[0][meter2]"   class="form-control" type="number" >
            </div>
            <div class="col-md-2">
                <label class="control-label"> عداد 3</label>
                <input  name="data[0][meter3]" class="form-control" type="number" >
            </div>
            <div class="col-md-2">
                <label class="control-label"> عدداد 4</label>
                <input  name="data[0][meter4]"  class="form-control" type="number" >
            </div>
            <div class="col-md-2">
                <label class="control-label">عداد 5</label>
                <input  name="data[0][meter5]"    class="form-control" type="number">
            </div>
            <div class="col-md-1">
                <label class="control-label">عداد 6</label>
                <input  name="data[0][meter6]"    class="form-control" type="number">
            </div>
